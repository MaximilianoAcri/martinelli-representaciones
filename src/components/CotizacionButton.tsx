...
export function CotizacionButton({ 
  ...
  return (
    <button 
      onClick={() => openModal()}
      className={`${baseClasses} ${sizeClasses} rounded-xl font-semibold transition-all text-center inline-flex items-center justify-center gap-2 hover-lift ${className}`}
    >
      {children}
    </button>
  );
...
export function WhatsAppButton({
  ...
  return (
    <a 
      ...
      className={`${variantClasses} ${sizeClasses} rounded-xl font-semibold transition-all text-center inline-flex items-center justify-center gap-2 hover-lift shadow-md hover:shadow-lg ${className}`}
    >
