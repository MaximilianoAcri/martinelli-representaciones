          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 slide-up animate-delay-400 mt-8">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 px-8 py-4 rounded-xl font-semibold text-lg transition-all text-center flex items-center justify-center gap-2 text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-600 hover-lift"
              >
