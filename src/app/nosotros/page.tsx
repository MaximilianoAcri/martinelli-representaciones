...
export default function NosotrosPage() {
  return (
    <div>
      {/* Header */}
      <section className="bg-stone-100 dark:bg-stone-900 text-slate-900 dark:text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <Link href="/" className="text-stone-600 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white transition-colors">
            ← Volver
          </Link>
      ...
      {/* Historia y Valores */}
      <section className="py-16 md:py-24 bg-slate-100 dark:bg-slate-900 transition-colors duration-300 relative overflow-hidden">
      ...
      <section className="py-16 md:py-24 bg-slate-200 dark:bg-slate-900 transition-colors duration-300 relative overflow-hidden">
        {/* Background Image with overlay */}
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/historia-bg.jpg"
            ...
            priority={false}
          />
          <div className="absolute inset-0 bg-slate-200/85 dark:bg-slate-900/85"></div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-slate-100 dark:bg-slate-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Por qué elegirnos */}
            <div className="bg-white dark:bg-slate-700 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-600">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700 dark:text-slate-200">Atención personalizada y asesoramiento técnico</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold text-xl">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Los mejores precios del mercado</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold text-xl">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Envíos a todo el país</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold text-xl">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Productos de primera calidad garantizada</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold text-xl">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Más de 20 años de experiencia en el mercado</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white dark:bg-slate-700 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-600">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-700 dark:text-slate-200">Venta de Chapas Perforadas y Decorativas</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Venta de Mallas Metálicas (Hexagonal, Gallinero, Simétrica)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Venta de Grifería Industrial y Comercial</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Venta de Materiales de Construcción</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-600 dark:text-green-400 font-bold">✓</span>
                  <span className="text-slate-700 dark:text-slate-200">Asesoramiento técnico personalizado</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-900 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contacto"
              className="bg-white hover:bg-slate-200 text-slate-900 px-8 py-4 rounded-xl font-semibold text-lg transition-colors"
            >
              Contactanos
            </Link>
          </div>
