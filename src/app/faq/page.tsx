...
export const metadata: Metadata = {
  title: "Preguntas Frecuentes - Martinelli Representaciones",
  description: "Respondemos las preguntas más frecuentes sobre nuestros productos, envíos, métodos de pago y atención.",
  keywords: ["preguntas frecuentes", "FAQ", "chapas perforadas", "mallas", "grifería", "envíos"],
};
      ...
      <section className="bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl">
            Respondemos las dudas más comunes sobre nuestros productos y servicios
          </p>
        </div>
      </section>
