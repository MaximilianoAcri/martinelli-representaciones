...
export const metadata: Metadata = {
  ...
  title: {
    default: "Martinelli Representaciones - Materiales Industriales",
    template: "%s | Martinelli Representaciones",
  },
  description:
    "Asesoramiento técnico especializado y atención personalizada. Envíos a todo el país. Más de 20 años de experiencia acompañando a la industria.",
  keywords: [
